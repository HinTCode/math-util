 ...
 */
package com.tincode.mathutil.test.core;

import com.tincode.mathutil.core.MathUtil;
...
public class MathUtilityTest {
    ...
    //nhưng thường sẽ là nói lên mục đích của các test/tình huống kiểm thử
    //tình huống xài hàm theo kiểu thành công và thất bại!!!
    
    //hàm dưới đây là tình huồng test hàm chạy thành công, trả về ngon
    ...
    //sure, HÀM CHẠY SAI THIẾT KẾ, SAI KÌ VỘNG, MÀU ĐỎ
    
    //Test case:
    //input: -5
    //exptected: IllegalArgumentException xuất hiện
    ...
    //khi hàm test này được chạy, ta kì vọng nó sẽ ném về ngoại lệ numberformatexception
