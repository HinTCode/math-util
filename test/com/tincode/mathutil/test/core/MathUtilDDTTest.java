...
//lấy cặp data input/expected nhồ vào hàm test
@RunWith(value = Parameterized.class)
public class MathUtilDDTTest {
    
    //ta sẽ trả về mảng 2 chiều, gồm nhiều cặp Excepted|Input
    @Parameterized.Parameters   //JUnit sẽ ngầm chạy loop qua từng dòng
                                //của mảng để lấy đc cặp data input/expected
    //tên hàm ko quan trọng, quan trọng là @, sẽ qui ước điều gì xảy ra
